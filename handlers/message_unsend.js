      ...
      if (typeof unsentData == "object") {
        if (unsentData[0] == "img") {
          var file = fs.createWriteStream(
            __dirname + "/../cache/unsentphoto.jpg"
          );
          ...
          var file = fs.createWriteStream(
            __dirname + "/../cache/unsentanimated_image.gif"
          );
          http.get(unsentData[1], function (rqs) {
            rqs.pipe(file);
            file.on("finish", function () {
          ...
          var file = fs.createWriteStream(
            __dirname + "/../cache/unsentsticker.png"
          );
          http.get(unsentData[1], function (rqs) {
            rqs.pipe(file);
            file.on("finish", function () {
          ...
          var file = fs.createWriteStream(
            __dirname + "/../cache/unsentvideo.mp4"
          );
          http.get(unsentData[1], function (rqs) {
            rqs.pipe(file);
            file.on("finish", function () {
          ...
          var file = fs.createWriteStream(
            __dirname + "/../cache/unsentvoicemessage.mp3"
          );
          http.get(unsentData[1], function (rqs) {
            rqs.pipe(file);
            file.on("finish", function () {
