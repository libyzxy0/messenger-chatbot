...
class VideoInfo extends MediaInfo {
    ...
    get music_tracks() {
        ...
        if (description_content !== undefined && description_content.length > 0) {
            const music_section = (_c = description_content[0].content) === null || _c === void 0 ? void 0 : _c.items.filter((item) => item === null || item === void 0 ? void 0 : item.is(VideoDescriptionMusicSection));
            if (music_section !== undefined && music_section.length > 0) {
                return (_d = music_section[0].carousel_lockups) === null || _d === void 0 ? void 0 : _d.map((lookup) => {
                    ...
                    song = (_a = lookup.video_lockup) === null || _a === void 0 ? void 0 : _a.title;
                    // If the video id isn't in the video_lockup, it should be in the info_rows
                    videoId = (_b = lookup.video_lockup) === null || _b === void 0 ? void 0 : _b.endpoint.payload.videoId;
                        ...
                        if (info_row.info_row_expand_status_key === undefined) {
                            if (song === undefined) {
                                ...
                                if (videoId === undefined) {
                                    videoId = (_c = info_row.metadata_endpoint) === null || _c === void 0 ? void 0 : _c.payload;
                                }
                            }
                            else {
                            ...
                            if (((_d = info_row.info_row_expand_status_key) === null || _d === void 0 ? void 0 : _d.indexOf('structured-description-music-section-artists-row-state-id')) !== -1) {
