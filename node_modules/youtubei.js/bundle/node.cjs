...
var InfoRow = class extends YTNode {
  constructor(data) {
    ...
    if (this.metadata_text === void 0) {
      this.metadata_text = ((_a7 = data.expandedMetadata) === null || _a7 === void 0 ? void 0 : _a7.simpleText) ? new Text(data.expandedMetadata) : ((_b2 = data.defaultMetadata) === null || _b2 === void 0 ? void 0 : _b2.simpleText) ? new Text(data.defaultMetadata) : void 0;
    }
...
var CarouselLockup = class extends YTNode {
  constructor(data) {
    ...
    const video_lockup = parser_default.parseItem(data.videoLockup, CompactVideo_default);
...
var VideoDescriptionHeader = class extends YTNode {
  constructor(data) {
    ...
    this.channel_navigation_endpoint = parser_default.parseItem(data.channelNavigationEndpoint, NavigationEndpoint_default) || void 0;
    this.channel_thumbnails = data.channelThumbnail.thumbnails.map((thumbnail) => thumbnail.url);
...
var StructuredDescriptionContent = class extends YTNode {
  constructor(data) {
    super();
    this.items = parser_default.parseArray(data.items, [VideoDescriptionHeader_default, ExpandableVideoDescriptionBody_default, VideoDescriptionMusicSection_default]);
  }
};
...
var EngagementPanelSectionList = class extends YTNode {
  constructor(data) {
    super();
    this.target_id = data.targetId;
    const content = parser_default.parseItem(data.content, [SectionList_default, ContinuationItem_default, StructuredDescriptionContent_default]);
    if (content !== null) {
    ...
    if (description_content !== void 0 && description_content.length > 0) {
      ...
      if (music_section !== void 0 && music_section.length > 0) {
        return (_d = music_section[0].carousel_lockups) === null || _d === void 0 ? void 0 : _d.map((lookup) => {
          var _a8, _b3, _c2, _d2, _e, _f, _g;
          let song, artist, album, license, videoId, channelId;
          song = (_a8 = lookup.video_lockup) === null || _a8 === void 0 ? void 0 : _a8.title;
          videoId = (_b3 = lookup.video_lockup) === null || _b3 === void 0 ? void 0 : _b3.endpoint.payload.videoId;
