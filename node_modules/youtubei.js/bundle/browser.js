...
var InfoRow = class extends YTNode {
  constructor(data2) {
    var _a6, _b;
    super();
    if ("defaultMetadata" in data2 && "runs" in data2.defaultMetadata) {
      const runs = data2.defaultMetadata.runs;
      if (runs.length > 0) {
        const run = runs[0];
        this.metadata_text = run === null || run === void 0 ? void 0 : run.text;
        if ("navigationEndpoint" in run) {
          this.metadata_endpoint = parser_default.parseItem({ navigationEndpoint: run.navigationEndpoint }, NavigationEndpoint_default) || void 0;
        }
      }
    }
    if ("expandedMetadata" in data2 && "runs" in data2.expandedMetadata) {
      this.metadata_text = new Text(data2.expandedMetadata);
    }
    if (this.metadata_text === void 0) {
      this.metadata_text = ((_a6 = data2.expandedMetadata) === null || _a6 === void 0 ? void 0 : _a6.simpleText) ? new Text(data2.expandedMetadata) : ((_b = data2.defaultMetadata) === null || _b === void 0 ? void 0 : _b.simpleText) ? new Text(data2.defaultMetadata) : void 0;
    }
...
var CarouselLockup = class extends YTNode {
  constructor(data2) {
    ...
    const video_lockup = parser_default.parseItem(data2.videoLockup, CompactVideo_default);
...
var ExpandableVideoDescriptionBody = class extends YTNode {
  constructor(data2) {
    ...
    this.attributed_description_body_text = {
      content: data2.attributedDescriptionBodyText.content
    };
  }
};
...
var VideoDescriptionHeader = class extends YTNode {
  constructor(data2) {
    ...
    this.channel_navigation_endpoint = parser_default.parseItem(data2.channelNavigationEndpoint, NavigationEndpoint_default) || void 0;
    this.channel_thumbnails = data2.channelThumbnail.thumbnails.map((thumbnail) => thumbnail.url);
...
var StructuredDescriptionContent = class extends YTNode {
  constructor(data2) {
    super();
    this.items = parser_default.parseArray(data2.items, [VideoDescriptionHeader_default, ExpandableVideoDescriptionBody_default, VideoDescriptionMusicSection_default]);
  }
};
...
var EngagementPanelSectionList = class extends YTNode {
  constructor(data2) {
    super();
    this.target_id = data2.targetId;
    const content = parser_default.parseItem(data2.content, [SectionList_default, ContinuationItem_default, StructuredDescriptionContent_default]);
    if (content !== null) {
...
var VideoInfo = class extends MediaInfo {
  ...
  get music_tracks() {
    ...
    if (description_content !== void 0 && description_content.length > 0) {
      const music_section = (_c = description_content[0].content) === null || _c === void 0 ? void 0 : _c.items.filter((item) => item === null || item === void 0 ? void 0 : item.is(VideoDescriptionMusicSection_default));
      if (music_section !== void 0 && music_section.length > 0) {
        return (_d = music_section[0].carousel_lockups) === null || _d === void 0 ? void 0 : _d.map((lookup) => {
          var _a7, _b2, _c2, _d2, _e, _f, _g;
          let song, artist, album, license, videoId, channelId;
          song = (_a7 = lookup.video_lockup) === null || _a7 === void 0 ? void 0 : _a7.title;
          videoId = (_b2 = lookup.video_lockup) === null || _b2 === void 0 ? void 0 : _b2.endpoint.payload.videoId;
          for (let i = 0; i < lookup.info_rows.length; i++) {
            ...
            if (info_row.info_row_expand_status_key === void 0) {
              if (song === void 0) {
                ...
                if (videoId === void 0) {
                  videoId = (_c2 = info_row.metadata_endpoint) === null || _c2 === void 0 ? void 0 : _c2.payload;
                }
              } else {
                album = info_row.metadata_text;
              }
            } else {
              if (((_d2 = info_row.info_row_expand_status_key) === null || _d2 === void 0 ? void 0 : _d2.indexOf("structured-description-music-section-artists-row-state-id")) !== -1) {
                artist = info_row.metadata_text;
                if (channelId === void 0) {
                  channelId = (_f = (_e = info_row.metadata_endpoint) === null || _e === void 0 ? void 0 : _e.payload) === null || _f === void 0 ? void 0 : _f.browseId;
                }
              }
              if (((_g = info_row.info_row_expand_status_key) === null || _g === void 0 ? void 0 : _g.indexOf("structured-description-music-section-licenses-row-state-id")) !== -1) {
